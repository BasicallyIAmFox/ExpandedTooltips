...
public class ETLanguageProvider extends LanguageProvider {
    ...
    private void soil() {
        ...
        addTooltip(Blocks.SUSPICIOUS_GRAVEL, "A block of sediment with ancient artifacts inside.");
    ...
    private void plant() {
        ...
        addTooltip(Blocks.PITCHER_PLANT, "An ancient plant dug up by Sniffers.");
    ...
    private void fungus() {
        ...
        addTooltip(Blocks.WEEPING_VINES, "Vine growing down from the ceiling, Commonly found in the Nether’s Crimson Forest.");
    }
    private void fauna() {
    ...
    private void algae() {
        addTooltip(Blocks.KELP, "An algae found growing in forest-like areas.", "Grows across many ocean biomes.");
    ...
    private void otherBlocks() {
        ...
        addTooltip(Blocks.CALIBRATED_SCULK_SENSOR, "A block made from a material of unknown origin.", "Infused with amethyst, allowing it to filter vibrations.");
        addTooltip(Blocks.SNIFFER_EGG, "The egg of an ancient creature, found in an ocean ruin.");
    }
    private void materials() {
        ...
        var potterySherds = addTooltipText("An ancient sherd found in the soil around ruins.");
        addTooltip(Items.ANGLER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.ARCHER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.ARMS_UP_POTTERY_SHERD, potterySherds);
        addTooltip(Items.BLADE_POTTERY_SHERD, potterySherds);
        addTooltip(Items.BREWER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.BURN_POTTERY_SHERD, potterySherds);
        addTooltip(Items.DANGER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.EXPLORER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.FRIEND_POTTERY_SHERD, potterySherds);
        addTooltip(Items.HEART_POTTERY_SHERD, potterySherds);
        addTooltip(Items.HEARTBREAK_POTTERY_SHERD, potterySherds);
        addTooltip(Items.HOWL_POTTERY_SHERD, potterySherds);
        addTooltip(Items.MINER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.MOURNER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.PLENTY_POTTERY_SHERD, potterySherds);
        addTooltip(Items.PRIZE_POTTERY_SHERD, potterySherds);
        addTooltip(Items.SHEAF_POTTERY_SHERD, potterySherds);
        addTooltip(Items.SHELTER_POTTERY_SHERD, potterySherds);
        addTooltip(Items.SKULL_POTTERY_SHERD, potterySherds);
    ...
    private void utility() {
        ...
        var smithingTemplates = addTooltipText("A tablet used to design or upgrade items.", "Applied with a Smithing Table.");
        addTooltip(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE, smithingTemplates);
